//! Erases the SoftDevice region (0x1000-0x26000) for boards with S140 v6.1.1
//! (e.g. nice!nano v2 with bootloader v0.6.0).
...
fn main() -> ! {
    ...
    // Erase pages from 0x1000 to 0x26000 (S140 v6.1.1 region)
